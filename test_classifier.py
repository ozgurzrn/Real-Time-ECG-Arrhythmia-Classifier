"""
Comprehensive test suite for ECG arrhythmia classifier.
...
TEST_CASES = [
    ...
    (100, "Normal with PVCs", "N"),  # Mostly normal with some ventricular ectopy
    (101, "Sinus rhythm with rare PVCs", "N"),
    
    # Ventricular Arrhythmias
    (106, "Frequent PVCs and ventricular bigeminy", "V"),
    (119, "Frequent PVCs", "V"),
    (200, "Atrial premature beats", "S"),
    
    # Supraventricular
    (209, "Atrial fibrillation", "S"),
    (220, "Normal with occasional PVCs", "N"),
    
    # Paced
    (102, "Paced rhythm", "Q"),  # Pacemaker rhythm
    (104, "Paced rhythm", "Q"),
    
    # Mixed/Complex
    (207, "Ventricular bigeminy", "V"),
    (208, "Mixed ventricular and supraventricular", "V"),
]

def create_test_csv(record_num, output_dir='test_samples'):
...
if __name__ == "__main__":
    print("="*70)
    print("ECG Arrhythmia Classifier - Comprehensive Test Suite")
    print("="*70)
    ...
    # Run tests
    print(f"\n🧪 Running tests on {len(test_files)} records...\n")
    ...
    print("\n" + "="*70)
    print(f"Test suite completed: {passed}/{total_tests} tests passed")
    print("="*70)
